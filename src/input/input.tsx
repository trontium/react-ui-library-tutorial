import React, { forwardRef, useState, ChangeEvent, KeyboardEvent, FocusEvent } from 'react';
...
const Input = forwardRef<HTMLInputElement, InputProps>((props, ref) => {
  ...
  const showClear = allowClear && !disabled && (rawValue !== undefined && rawValue !== null && rawValue !== '');
  ...
  const renderClearIcon = () => {
      ...
      return (
         <span className={`${prefixCls}-suffix ${prefixCls}-clear-icon`} onClick={handleClear} style={{ cursor: 'pointer', color: '#ccc', fontSize: 12 }}>
